<script lang="ts">
	...
	import {
		...
		Sparkles, Settings, HelpCircle, ChevronDown, Crown, X
	} from '@lucide/svelte';
...
<aside
	...
	style="left:12px;width:236px;background:rgba(255,255,255,0.78);backdrop-filter:blur(20px);border-radius:32px;border:1px solid rgba(255,255,255,0.55);box-shadow:8px 8px 24px rgba(0,0,0,0.08),-8px -8px 24px rgba(255,255,255,0.9);"
>
	<!-- Logo -->
	<div class="px-5 pt-5 pb-2">
		<div class="flex items-center gap-3">
			...
			<div>
				<p class="text-sm font-bold leading-tight" style="color:#1a1a2e;">Finova</p>
				<p class="text-xs leading-tight" style="color:#9ca3af;">Kelola keuangan lebih bijak</p>
			</div>
		</div>
	</div>
...
<aside
	...
	style="width:280px;background:rgba(255,255,255,0.96);backdrop-filter:blur(20px);border-right:1px solid rgba(255,255,255,0.5);box-shadow:8px 0 32px rgba(0,0,0,0.12);transform:{sidebarOpen ? 'translateX(0)' : 'translateX(-100%)'};"
>
	<!-- Mobile header -->
	<div class="flex items-center justify-between px-5 pt-5 pb-3">
		<div class="flex items-center gap-3">
			...
			<div>
				<p class="text-sm font-bold" style="color:#1a1a2e;">Finova</p>
				<p class="text-xs" style="color:#9ca3af;">Kelola keuangan lebih bijak</p>
			</div>
		</div>
